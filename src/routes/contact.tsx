  ...
  head: () => ({
    meta: [
      { title: "Contact — Codehence" },
      {
        name: "description",
        content:
          "Book a free 30-minute consultation with the Codehence team — SaaS development, MVP builds, AI integrations, and workflow automation.",
      },
      { property: "og:title", content: "Contact Codehence" },
      {
        property: "og:description",
        content: "Book a free consultation. We'll listen first, propose later.",
      },
    ],
  }),
            ...
            {state.kind === "success" ? (
              ...
              <>
                ...
                <p className="mt-1 text-sm text-muted-foreground">
                  We'll route it to the right human.
                </p>
