...
export const products: Product[] = [
  {
    name: "DocSense",
    description:
      "Upload any document — get instant answers, summaries, and structured extractions backed by RAG.",
    longDescription:
  ...
  },
  {
    name: "ChatStack",
    description:
      "Build branded AI chat assistants on top of your docs, sites, and knowledge bases — in minutes, not weeks.",
    longDescription:
